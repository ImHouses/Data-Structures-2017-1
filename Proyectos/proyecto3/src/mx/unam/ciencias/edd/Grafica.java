    ...
    */
    ...
    public void conecta(T a, T b, double peso) {
        ...
        if (sonVecinos(a,b) || a.equals(b) || peso < 1)
            throw new IllegalArgumentException("Elementos ya conectados o " + 
                        "iguales; o peso negativo.");
    ...
    public boolean sonVecinos(T a, T b) {
        return castVertice(vertice(a)).vecinos.contiene(b);
    }
    ...
    public double getPeso(T a, T b) {
        ...
        return castVertice(vertice(a)).vecinos.get(b).peso;
    }
    ...
    private void recorrido(T elemento, MeteSaca<Vertice> meteSaca,
        ...
        if (vertices.esVacio())
            return;
        Vertice v = castVertice(vertice(elemento));
        paraCadaVertice((va) -> va.setColor(Color.NINGUNO));
        meteSaca.mete(v);
        ...
        paraCadaVertice((vb) -> vb.setColor(Color.NINGUNO));
    }

...
public class TestFabricaDispersores {
   ...
   private int[] dispersoresBJ = {
    ...
    /**
     * Prueba unitaria para {@link FabricaDispersores#getInstancia} con la
    ...
    @Test public void testGetInstanciaStringBJ() {
        ...
        for (String mensaje : mensajes)
            Assert.assertTrue(bj.dispersa(mensaje) == dispersoresBJ[i++]);
    }
    ...
    @Test public void testGetInstanciaStringGLib() {
        ...
        int i = 0;
        for (String mensaje : mensajes)
            Assert.assertTrue(bj.dispersa(mensaje) == dispersoresGLib[i++]);
    }
    ...
    @Test public void testGetInstanciaStringXOR() {
        ...
        int i = 0;
        for (String mensaje : mensajes)
            Assert.assertTrue(bj.dispersa(mensaje) == dispersoresXOR[i++]);
    }
}
